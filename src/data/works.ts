...
export const COPY = {
  ...
  exhibitions: [
    {
      id: 'fotolivros-move-2025',
      year: '2025',
      title: 'Fotolivros e libros de artista',
      venue: 'Espacio Move Arte',
      city: 'São Paulo',
      images: ['fotolivros-move-2025.jpg', 'fotolivros-move-flyer.jpg'],
    },
    {
      id: 'desdobrando-linhas-2024',
      year: '2024',
      title: 'Desdobrando linhas',
      venue: 'Espacio Move Arte',
      city: 'São Paulo',
      images: ['desdobrando-linhas-2024.jpg', 'desdobrando-linhas-ig.jpg'],
    },
    {
      id: 'experimentando-olhar-2024',
      year: '2024',
      title: 'Experimentando um olhar de criança em nós',
      venue: 'Espacio Move Arte',
      city: 'São Paulo',
      images: ['experimentando-olhar-2024.jpg'],
    },
    {
      id: 'move-24',
      year: '2024',
    ...
    },
    {
      id: 'kentler-2023',
      year: '2023',
      title: '100 works on paper benefit',
      venue: 'Kentler International Drawing Space',
      city: 'Brooklyn, NY',
      images: ['kentler-2023.jpg', 'kentler-drawing.jpg'],
    },
    {
      id: 'villaggio-2023',
      year: '2023',
      title: 'Encontro de arte Villaggio',
      venue: 'Condominio Villaggio Panamby',
      city: 'São Paulo',
      images: ['villaggio-2023.jpg'],
    },
    {
      id: 'sp-arte-2023',
      year: '2023',
      title: 'Roteiro de ateliês SP Arte',
      venue: 'Atelier Lavandería',
      city: 'São Paulo',
      images: ['sp-arte-2023.jpg'],
    },
    {
      id: 'ale-residencia-2022',
      year: '2022',
      title: 'Residencia artística',
      venue: 'Alê Espacio de Arte',
      city: 'São Paulo',
      images: ['ale-residencia-2022.jpg', 'ale-residencia-2022-b.jpg'],
    },
    {
      id: 'artvilo-2017',
      year: '2017',
      title: 'Primer premio en grabado — Artvilo',
      venue: 'Municipalidad de Vicente López',
      city: 'Buenos Aires',
      images: ['artvilo-2017.jpg'],
    },
    {
      id: 'soluciones-impresas-2016',
      year: '2016',
      title: 'Soluciones Impresas',
      venue: 'Exposición individual',
      city: 'Buenos Aires',
      images: ['soluciones-impresas-2016.jpg'],
    },
    {
      id: 'arte-si-2009',
      year: '2009',
      title: 'Feria Supermercado de Arte — Arte SI',
      venue: '',
      city: 'Buenos Aires',
      images: ['arte-si-2009.jpg'],
    },
    {
      id: 'vademecum',
      year: '',
      title: 'Libro Vademécum del grabado',
      venue: 'Colaboración con Graciela Buratti',
      city: 'librodearte.com.ar',
      url: 'https://librodearte.com.ar/libro-vademecum/',
      images: ['vademecum-libro.jpg', 'vademecum-pagina.jpg'],
    },
  ],
  videosTitle: 'Videos',
  videos: [
